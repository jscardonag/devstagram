        ...
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                @auth
                    ...
                    @endif
                    <form action="{{ route('comments.store', ['post' => $post, 'user' => $user->username]) }}" method="POST">
                        @csrf
                        <div class="mb-5">
                ...
                @endauth
                <div class="bg-white shadow mb-5 mx-h96 overflow-y-scroll mt-10">
                    @if ($post->comments->count())
                        @foreach ($post->comments as $comment)
                            <div class="p-5 border-gray-300 border-b">
                                <a href="{{ route('posts.index', $comment->user) }}"
                                    class="font-bold">{{ $comment->user->username }}
                                </a>
                                <p>{{ $comment->comment }}</p>
